...
// facebookController.hears('บัตรนักศึกษาจะได้รับภายในกี่วัน', 'message_received', function(bot, message){
//   facebookBot.reply(message, 'สามารถขอทรานสคริปต์ได้ที่สำนักทะเบียนฯ อาคารกรมหลวงนราธิวาสราชนครินทร์ ชั้น 2 โดยมีค่าธรรมเนียม 50 บาทต่อทรานสคริปต์หนึ่งใบ');
// });

facebookController.hears('ขอใบเสร็จชำระเงินค่าเทอมได้ที่ไหน', 'message_received', function(bot, message){
  facebookBot.reply(message, 'สามารถติดต่อขอรับใบเสร็จชำระเงินค่าเทอมได้ที่ ส่วนงานการคลัง อาคารกรมหลวงนราธิวาสราชนครินทร์ ชั้น 3');
});
